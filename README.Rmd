...
Categories "no light perception", "light perception", "count fingers" and "hand movement" are converted [following the suggestions by Michael Bach](https://michaelbach.de/sci/pubs/Bach2007IOVS%20eLetter%20FrACT.pdf). Further interesting information can be found on [his homepage](https://michaelbach.de/sci/acuity.html)
