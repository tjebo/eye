...
*eye* includes the [real life data sets](#data-sets) `amd` [@fasler] and `dme` [@fu], of people who received intravitreal injections due to age-related macular degeneration or diabetic macular edema in **Moorfields Eye Hospital**. 
...
**Kindly reference those data sets by citing the corresponding publications** [@fasler] and [@fu].
