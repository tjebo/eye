...
WARNING - eye is currenty under heavy development - would recommend currently to install eye from CRAN
...
## Installation
You can install eye from [CRAN](https://cran.r-project.org/web/packages/eye/index.html) using `install.packages("eye")` 
