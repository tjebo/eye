...
### va
Easy conversion from visual acuity notations in a single call to `va()`. The notation will automatically be detected and converted to the desired notation. For some more details see [VA conversion](#va-conversion). For entries with 
mixed notation, use `va_mixed` instead.
```{r va}
