...
If you have different codes, you can change the recognized strings with the `eyecodes` argument, which needs to be a list. But remember to put the strings for right eyes first, or pass a *named list*. 
```{r}
...
#### eye variable column:
- names can be in any case.
- `eyes` looks for columns that contain the string either "eye" or "eyes"
